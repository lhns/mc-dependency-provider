...
// MC 26.1 band — Mojang's calendar versioning. Bundles fabric-26.1 + neoforge-26.1.
java {
    toolchain {
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("de.lhns.mcdp", "mcdp-26.1", project.version.toString())
    pom {
        name.set("mcdp-26.1")
        description.set("Multi-loader (Fabric + NeoForge) JVM-language mod provider for MC 26.1.")
