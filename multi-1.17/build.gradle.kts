...
// MC 1.17 band aggregator. Fabric + Forge for 1.17.x. Java 16 target.
java {
    toolchain {
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("de.lhns.mcdp", "mcdp-1.17", project.version.toString())
    pom {
        name.set("mcdp-1.17")
        description.set("Multi-loader (Fabric + Forge) JVM-language mod provider for MC 1.17.")
