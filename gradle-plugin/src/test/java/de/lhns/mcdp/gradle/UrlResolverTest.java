...
/**
 * Exercises {@link GenerateMcdpManifestTask.UrlResolver}'s HEAD-probe behaviour across multiple
...
class UrlResolverTest {
    ...
    void picksSecondRepoWhenFirstReturns404() {
        ...
        GenerateMcdpManifestTask.UrlResolver resolver =
                new GenerateMcdpManifestTask.UrlResolver(List.of(missBase, hitBase));

        GenerateMcdpManifestTask.ArtifactCoord coord = new GenerateMcdpManifestTask.ArtifactCoord(
    ...
    void singleRepoSkipsProbingEntirely() {
        GenerateMcdpManifestTask.UrlResolver resolver =
                new GenerateMcdpManifestTask.UrlResolver(List.of(hitBase));
    ...
    void fallsBackToFirstRepoWhenAllProbesFail() {
        ...
        GenerateMcdpManifestTask.UrlResolver resolver =
                new GenerateMcdpManifestTask.UrlResolver(List.of(missBase, missBase));
