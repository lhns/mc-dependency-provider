 ...
 * {@link McLibProvider#loadMixinImpl(Class)}. The interface is declared under a
 * {@code shared_packages} prefix so its {@code Class} identity is preserved across the mod and
 * game classloaders.
 *
 * <pre>{@code
 * @Mixin(FlowingFluid.class)
 * @McLibMixin(impl = "de.lolhens.fluidphysics.impl.FlowableFluidLogicScala")
