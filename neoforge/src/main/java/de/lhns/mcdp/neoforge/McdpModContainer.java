 ...
 * the per-mod {@link IEventBus} that {@link McdpLanguageLoader} built before constructing the
...
public final class McdpModContainer extends ModContainer {
    ...
    public McdpModContainer(IModInfo info, Object modInstance, IEventBus eventBus) {
        super(info);
